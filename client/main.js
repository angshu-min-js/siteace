...
Router.plugin('seo', {
  ...
  defaults: {  title: 'SiteAce',                 // Will apply to <title>, Twitter and OpenGraph.
  suffix: 'SiteAce',
  separator: '·',

  description: 'This a coursera assignment',        // Will apply to meta, Twitter and OpenGraph.
  image: 'http://domain.com/image.png',   // Will apply to Twitter and OpenGraph.

  meta: {
    keywords: ['Coursera', 'Meteor', 'siteace']
  },

  twitter: {
    card: 'summary',
    creator: '@angshumangupta'
    // etc.
  },
...
Template.site_form.events({
    ...
    'submit .js-save-site-form': function(event) {
        ...
        //var result = HTTP.call("GET", "http://"+"+url+")
        //console.log(result);
